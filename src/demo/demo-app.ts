...
export class DemoApp {
    ...
    bind() {
        ValidationRules
            ...
            .ensure<boolean>(r => r.checked1)
               .satisfies((value) => value).withMessage("Checked 1 must be switched on")
            .ensure<boolean>(r => r.checked2)
               .satisfies((value) => value).withMessage("Checked 2 must be checked")
